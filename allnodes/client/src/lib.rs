use {
    allnodes_service_protos::{
        client::AllnodesServiceClient, BootstrapInfoRequestPb, BootstrapInfoResponse,
        BootstrapSnapshotNode, CoreConfig, Flags, GetServiceInfoRequest, HeartbeatRequest,
        ProcessPohCoreConfigRequest, ProcessPohCoreConfigResponse, ServiceCapabilities,
